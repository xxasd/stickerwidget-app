const translations = {
  en: {
    ...
    appName: "Little Sticker",
    photoWidgetsTitle: "Photo Widgets",
    photoWidgetsDesc: "Display your favorite memories right on your home screen",
    smartCountdownsTitle: "Smart Countdowns",
    smartCountdownsDesc: "Never miss important dates with beautiful countdown timers",
    calendarIntegrationTitle: "Calendar Integration",
  ...
  "zh-CN": {
    ...
    appName: "小贴纸",
    photoWidgetsTitle: "照片小组件",
    photoWidgetsDesc: "在主屏幕上展示你最珍贵的回忆",
    smartCountdownsTitle: "智能倒计时",
    smartCountdownsDesc: "用精美的倒计时不错过任何重要日子",
    calendarIntegrationTitle: "日历集成",
  ...
  "zh-TW": {
    ...
    appName: "小貼紙",
    photoWidgetsTitle: "照片小工具",
    photoWidgetsDesc: "在主畫面上展示你最珍貴的回憶",
    smartCountdownsTitle: "智能倒數計時",
    smartCountdownsDesc: "用精美的倒數計時不錯過任何重要日子",
    calendarIntegrationTitle: "日曆整合",
  ...
  ja: {
    ...
    appName: "Little Sticker",
    photoWidgetsTitle: "写真ウィジェット",
    photoWidgetsDesc: "お気に入りの思い出をホーム画面に表示",
    smartCountdownsTitle: "スマートカウントダウン",
    smartCountdownsDesc: "美しいカウントダウンタイマーで大切な日を逃さない",
    calendarIntegrationTitle: "カレンダー連携",
  ...
  ko: {
    ...
    appName: "Little Sticker",
    photoWidgetsTitle: "사진 위젯",
    photoWidgetsDesc: "가장 소중한 추억을 홈 화면에 표시하세요",
    smartCountdownsTitle: "스마트 카운트다운",
    smartCountdownsDesc: "아름다운 카운트다운 타이머로 중요한 날을 놓치지 마세요",
    calendarIntegrationTitle: "캘린더 연동",
  ...
  de: {
    ...
    appName: "Little Sticker",
    photoWidgetsTitle: "Foto-Widgets",
    photoWidgetsDesc: "Zeige deine Lieblingserinnerungen direkt auf deinem Home-Bildschirm",
    smartCountdownsTitle: "Smarte Countdowns",
    smartCountdownsDesc: "Verpasse nie wieder wichtige Termine mit schönen Countdown-Timern",
    calendarIntegrationTitle: "Kalender-Integration",
...
function updateSwitcherUI(currentLang) {
  ...
  if (btn) {
    btn.setAttribute('aria-label', `Change language, current: ${supportedLanguages[currentLang]}`);
  }
